...
public class ImageController {
    ...
    @PutMapping("{imgurlImageId}")
    @ResponseStatus(HttpStatus.OK)
    public ImageResponse updateImage(@RequestParam(value = "title", required = false) String title,
                                     @RequestParam(value = "description", required = false) String description,
                                     @PathVariable String imgurlImageId)
        ...
        return imageService.updateImage(imgurlImageId, title, description);
    }
