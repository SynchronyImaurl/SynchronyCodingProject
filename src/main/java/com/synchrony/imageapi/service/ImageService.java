...
public class ImageService {
    ...
    public ImageResponse updateImage(String imageId, String title, String description) throws UnirestException {


        Image image = imageRepository.findByImgurlImageId(imageId);
        if (image == null) {
            throw new IllegalArgumentException("No image record with id: " + imageId);
        }
        imgurlImageService.updateImage(imageId, title != null ? title : image.getTitle(), description != null ? description : image.getDescription());
